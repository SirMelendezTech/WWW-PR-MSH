...
const en = {
  ...
  map: {
    ...
    lastSeen: "last seen",
    calloutLive: "Live data",
    calloutSample: "Sample data — live feed unreachable",
    liveBodyBefore: "Node positions come from the ",
    liveBodyMonitor: "Meshtastic PR Network Monitor",
    liveBodyMid: ", powered by ",
    liveBodyMalla: "Malla",
    liveBodyAfter:
      ", fetched once when this page was last built — refresh happens on the next site build, not in real time in your browser. Precision reflects whatever each operator configured on their node; this page never sharpens a position beyond what the node itself reports, and an operator who wants to stay off the map entirely can do so from their own device.",
    sampleBody:
      "The live feed from the Meshtastic PR Network Monitor didn't respond during the last build, so the markers above are illustrative demo positions, not real operator locations. The next successful build will restore live data automatically — no code change needed.",
...
const es: Strings = {
  ...
  map: {
    ...
    calloutLive: "Datos en vivo",
    calloutSample: "Datos de muestra — fuente en vivo no disponible",
    liveBodyBefore: "Las posiciones de los nodos vienen del ",
    liveBodyMonitor: "Meshtastic PR Network Monitor",
    liveBodyMid: ", impulsado por ",
    liveBodyMalla: "Malla",
    liveBodyAfter:
      ", obtenidas una vez cuando esta página se compiló por última vez — la actualización ocurre en la próxima compilación del sitio, no en tiempo real en tu navegador. La precisión refleja lo que cada operador configuró en su nodo; esta página nunca afina una posición más allá de lo que el propio nodo reporta, y un operador que quiera quedar fuera del mapa por completo puede hacerlo desde su propio equipo.",
    sampleBody:
      "La fuente en vivo del Meshtastic PR Network Monitor no respondió durante la última compilación, así que los marcadores de arriba son posiciones de demostración ilustrativas, no ubicaciones reales de operadores. La próxima compilación exitosa restaurará los datos en vivo automáticamente — sin cambios de código.",
